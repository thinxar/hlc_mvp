...
public class BatchTsxConverter {
	...
	public static void main(String[] args) {
		String inputDir = "/home/palmyra/suresh/templates/";
		String outputDir = "/home/palmyra/mydev/hlc_mvp/web/src/endorsementsTemplate/";
	...
	private static void processDirectory(File rootDir, File currentDir, File outputRoot) {
	    for (File file : currentDir.listFiles()) {
	        if (file.isDirectory()) {
	            ...
	            // ✅ FIX: recurse into subdirectory with newOutputDir as outputRoot
	            processDirectory(rootDir, file, newOutputDir);
