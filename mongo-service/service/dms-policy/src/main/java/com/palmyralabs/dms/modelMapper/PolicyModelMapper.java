package com.palmyralabs.dms.modelMapper;
...
public class PolicyModelMapper {
	...
	public PolicyFileModel toPolicyFileModel(PolicyFileEntity entity) {
	...
	public PolicyModel toPolicyModel(PolicyEntity entity) {
