...
@CrudMapping(mapping = "/masterdata/fixedStamp", type = FixedStampModel.class, secondaryMapping = "/masterdata/fixedStamp/{id}")
@Component
@Permission(value = "MasterData", query = "RS", read = "RS", create = "CU", update = "CU")
public class FixedStampHandler  extends AbstractHandler implements QueryHandler, ReadHandler, SaveHandler{
