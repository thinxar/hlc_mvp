package com.palmyralabs.palmyra.filemgmt.common;
 ...
 * Based on
 * https://github.com/davinkevin/Podcast-Server/blob/v1.0.0/src/main/java/lan/dk/podcastserver/service
...
// ** internal setter **//
	...
	public MultipartFileSender setFileName(String name) {
...
// ---------------------------------------------------
		...
		if (!checkHeader(fileName, lastModified)) {
			return;
		}
...
// Initialize response.
		...
		response.setHeader("Content-Disposition", disposition + ";filename=\"" + suggestedName + "\"");
		logger.debug("Content-Disposition : {}", disposition);
		response.setHeader("Accept-Ranges", "bytes");
		response.setHeader("ETag", suggestedName);
...
// End with multipart boundary.
	...
	private boolean checkHeader(String fileName, long lastModified) throws IOException {
// Validate request headers for caching
// ---------------------------------------------------
