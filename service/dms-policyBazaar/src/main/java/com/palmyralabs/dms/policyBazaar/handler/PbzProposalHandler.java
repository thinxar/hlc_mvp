...
/**
 * Query/read endpoint for pbz_policy. Replaces PbzProposalService.searchPolicies
 * (MongoTemplate) and the GET /pbv/proposal controller method.
 *
 ...
 */
@Component
@CrudMapping(mapping = "/pbv/proposal", type = PbzProposalModel.class, secondaryMapping = "/pbv/proposal/{id}")
public class PbzProposalHandler extends AbstractHandler implements QueryHandler, ReadHandler {
