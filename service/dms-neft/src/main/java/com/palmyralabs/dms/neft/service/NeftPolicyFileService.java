...
public class NeftPolicyFileService {
	...
	public List<NeftPolicyFileModel> getAllPolicyFiles(Integer policyId) {
		List<NeftPolicyFileEntity> policyFileEntities = policyFileRepository
				.findByPolicyId_IdOrderByDocketTypeAsc(policyId);
	...
	public NeftPolicyFileModel getById(Integer policyId, Integer id) {
		NeftPolicyFileEntity entity = policyFileRepository.findByPolicyId_IdAndId(policyId, id);
		if (entity != null) {
			return modelMapper.toPolicyFileModel(entity);
		} else {
