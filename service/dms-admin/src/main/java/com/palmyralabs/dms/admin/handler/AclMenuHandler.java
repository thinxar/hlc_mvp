...
import com.palmyralabs.dms.admin.model.AclMenuModel;
...
@CrudMapping(mapping = "/acl/menu", type = AclMenuModel.class)
@Component
public class AclMenuHandler implements QueryHandler {
