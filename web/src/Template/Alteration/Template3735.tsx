...
<tr>
<td width="25"></td>
<td width="550"><p className="text-align: justify;"> Received Rs. <TextField attribute="value13" type="text" /> in respect of difference of the premiums paid with interest thereon and Rs. <TextField attribute="value14" type="text" /> as interest for dating back. </p></td>
<td width="25"></td>
</tr>
</table>
<br />
