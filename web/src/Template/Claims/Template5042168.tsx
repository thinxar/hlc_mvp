...
const Template5042168 = (props: any) => {
  return (
...
<br />
<center> Ref: Policy No. <TextField attribute="polNumber" type="text" /> on the Life of <TextField attribute="value4" type="text" />
</center>
<br />
<br />
<table width="600">
