...
<tr>
<td width="25"></td>
<td width="250" align="left"><p className="text-justify"> Place: <TextView attribute="branchName" /> <td width="300" align="right">Date: <TextView attribute="currDate" />
</td>
</p>
</td>
<td width="25"></td>
