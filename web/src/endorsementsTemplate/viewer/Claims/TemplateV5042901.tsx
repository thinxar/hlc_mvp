...
<tr>
<td width="25"></td>
<td width="550" align="left"><p className="text-align: justify;"> The within-named Life Assured having died on" type="text" />value5<TextView attribute="and proof of his death having been duly furnished,it is hereby declared that the within-written policy stands reduced to Rs." type="text" />value6%% payable on the date of Maturity, and is free from payment of future premiums. The policy will not participate in future profits. </p></td>
<td width="25"></td>
</tr>
</table>
<br />
