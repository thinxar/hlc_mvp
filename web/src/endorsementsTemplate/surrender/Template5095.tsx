    ...
    return (
        <div className="form-container flex items-center justify-center bg-white text-blue-500 font-[500] template-sec">
            <div className="border-double border-4 border-gray-500 p-3 w-190">
                <h5 className="text-right mb-5">Form No. 5095</h5>
                <h3 className="text-center">LIFE INSURANCE CORPORATION OF INDIA</h3>
                <h5 className="text-center">
                    <u>FORM OF ENDORSEMENT-PUP FREE FROM LOAN AND INTEREST (TO BE USED IN THE CASE OF FULLY PAID POLICY)</u>
                </h5>
                <PalmyraForm ref={props.formRef}>
                    ...
                    <div className="p-6 pt-0 pb-0 mt-12 text-justify">
                        At the request of the within named Life Assured the within written Policy which stood fully paid up by payment of the final
                        ...
                        . It is further declared that the Policy will not participate in the profits and will become payable as within
