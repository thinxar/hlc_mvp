        ...
        <tr>
          <th>
            ...
            <table width="600">
              <tr>
                <td width="25"></td>
                <td width="550" align="center"><b>Re : Policy No. <TextField attribute="polNumber" type="text" readOnly /></b></td>
              </tr>
            </table>
            <br /><br />
            <table>
              ...
              <tr>
                <td width="25"></td>
                <td width="550">
                  <p className="justify">The sum of Rs <TextField attribute="value10" type="text" /> has been paid as surrender value of the portion of the Sum Assured dropped.</p>
                </td>
                <td width="25"></td>
              </tr>
            </table>
