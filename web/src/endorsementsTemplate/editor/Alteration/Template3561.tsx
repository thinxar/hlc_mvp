...
<b>Re : Policy No.</b> <TextField attribute="polNumber" type="text" /> </td>
</tr>
</table>
<br />
<br />
...
<tr>
<td width="50"></td>
<td width="500" align="left"><p className="text-align: justify;"> Table No <TextField attribute="value9" type="text" /> .<br /> Received Rs <TextField attribute="value10" type="text" /> being the amount required to give effect	to the alteration. </p></td><td width="50"></td>
</tr>
</table>
<br />
<br />
