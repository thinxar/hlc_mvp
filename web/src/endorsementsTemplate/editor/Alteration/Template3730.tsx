          ...
          <td>
            ...
            <table width="600">
              <tr>
                <td width="25"></td>
                <td width="550">
                  <p className="text-justify"> Age at entry Admitted <TextField attribute="value4" type="text" /> years.<br /> <TextField attribute="value5" type="text" /> premium payable from <TextField attribute="value6" type="text" /> altered to <TextField attribute="value7" type="text" />.<br /> Inclusive Paid-up Assurance to Rs. <TextField attribute="value8" type="text" />.<br /> Increased Cash Payment Rs. <TextField attribute="value9" type="text" />. </p>
                </td>
                <td width="25"></td>
              </tr>
            </table>
