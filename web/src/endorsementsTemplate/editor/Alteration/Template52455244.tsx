...
const Template52455244 = (props: any) => {
  return (
           <PalmyraForm ref={props.formRef} formData={props.formData}>
<table width="600" >
<th>
<h5 className="text-right">(Form No. 5245)<br />(Corresponding to Form No. 5244)</h5>
<h3 className="text-center">LIFE INSURANCE CORPORATION OF INDIA</h3>
<h4 className="text-center"><u>Alteration</u></h4><br />
<h4 className="text-center"><u>Endorsement for Deed Poll of Appointment of Special Trustee.</u></h4>
...
<tr>
<td width="25"></td>
<td width="550" > *(a)<TextField attribute="value10" type="text" /> (Shri/Smt.) <TextField attribute="value2" type="text" /> as Special Trustee. <br />
</td>
<td width="25"></td>
</tr>
</table><br />
