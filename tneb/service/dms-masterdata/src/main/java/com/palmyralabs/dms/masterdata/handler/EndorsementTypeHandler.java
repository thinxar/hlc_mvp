...
@CrudMapping(mapping = "/masterdata/endorsementType", type = EndorsementTypeModel.class, secondaryMapping = "/masterdata/endorsementType/{id}")
@Component
@Permission(value = "MasterData", query = "RS", read = "RS", create = "CU", update = "CU")
public class EndorsementTypeHandler extends AbstractHandler implements QueryHandler, ReadHandler, SaveHandler{
