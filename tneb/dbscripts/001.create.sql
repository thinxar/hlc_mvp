CREATE SCHEMA IF NOT EXISTS tneb_dms;

SET search_path TO tneb_dms;
...
CREATE TABLE xpm_menu (
  ...
  category SMALLINT NULL DEFAULT '1',
  external_url VARCHAR(255) NULL DEFAULT NULL,
  created_by VARCHAR(128) NOT NULL,
  last_upd_by VARCHAR(128) NULL,
  created_on TIMESTAMP NOT NULL,
  last_upd_on TIMESTAMP,
  CONSTRAINT uq_page_code_action UNIQUE (code, action, object_id),
  CONSTRAINT xpm_menu_pkey PRIMARY KEY (id),
