...
INSERT INTO xpm_user (id,display_name, login_name, email, gender, dob, first_name, last_name, user_type, phone_number, flat_no, street, city, state, display_page, random, salt, created_by, created_on, last_upd_by, last_upd_on) VALUES
    (1,'Admin', 'admin@gmail.com','admin@gmail.com', 'M', '2023-09-04', 'Admin', 'Admin', 1,'9874839383','0/001', 'West Street', 'Chennai', '33', 1, NULL, 'ad', 'raja', current_timestamp, NULL, NULL);