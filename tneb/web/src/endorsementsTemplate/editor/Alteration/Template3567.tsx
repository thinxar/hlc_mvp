        ...
        <tbody>
          <th>
            ...
            <table width="600">
              <tbody><tr>
                <td width="25"></td>
                <td width="200" align="left"> Place: <TextField attribute="branchName" type="text" />
                </td><td width="350" align="right"> Date: <DatePicker attribute="currDate" placeholder="dd-mm-yyyy" readOnly/>
                </td>
              </tr>
              </tbody></table><br />
            <br />
              ...
              <tbody><tr>
                ...
                <td width="550">
                  <p className="text-align: justify;">
                    ...
                    within named Life Assured made prior to the date of maturity, that is <TextField type="text" attribute="value3" />, the Life Assured may, in the
              ...
              <tbody><tr>
                ...
                <td width="410" align="center" className='border-1 border-gray-600'>Amount of Annuity per annum payable as specified below for the
                  ...
                  <td width="410" className='border border-gray-600' >
                    <table>
                      <tbody><tr >
                        <td width="100" align="center"> <TextField type="text" attribute="value4" /> </td>
                        <td width="100" align="center"> <TextField type="text" attribute="value5" /> </td>
                        <td width="110" align="center"> <TextField type="text" attribute="value6" /> </td>
                        <td width="100" align="center"> <TextField type="text" attribute="value7" /> </td>
                      </tr>
                      </tbody></table>
                  </td>
                </tr><tr>
                  ...
                  <td width="150" align="center" className='border border-gray-600'>
                    <table>
                      <tbody><tr>
                        ...
                        <td width="130" align="left" className=''> Payable for <TextField type="text" w={'100px'} attribute="value8" /> years certain and so long hereafter as
                  ...
                  <td width="410" className='border border-gray-600'>
                    <table >
                      <tbody><tr>
                        <td width="100" height="20" align="center"> <TextField type="text" attribute="value9" /> </td>
                        <td width="100" align="center"> <TextField type="text" attribute="value10" /> </td>
                        <td width="110" align="center"> <TextField type="text" attribute="value11" /> </td>
                        <td width="100" align="center"> <TextField type="text" attribute="value12" /> </td>
                      </tr>
                      </tbody></table>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td width="550">
                    ...
                    <p className="text-align: justify;">2. <i>Duration of payment of Instalments :</i> In the case
                      ...
                      continued to be paid so long as the Assured is alive. In the case of Annuity for <TextField type="text" attribute="value13" />
                      years certain and so
                      long thereafter as the Assured may be alive the instalments will be continued to be
                      paid for <TextField type="text" attribute="value14" /> years
