          ...
          <td>
            ...
            <table width="600">
              <tr>
                <td width="25"></td>
                <td width="550">
                  <p className="text-justify"> Age at entry Admitted <TextView attribute="value4" /> years.<br /> <TextView attribute="value5" /> premium payable from <TextView attribute="value6" /> altered to <TextView attribute="value7" />.<br /> Inclusive Paid-up Assurance to Rs. <TextView attribute="value8" />.<br /> Increased Cash Payment Rs. <TextView attribute="value9" />. </p>
                </td>
                <td width="25"></td>
              </tr>
            </table>
